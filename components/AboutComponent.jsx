    ...
    <div className="container py-12 xl:py-24 h-auto lg:justify-between mx-auto">
      <div className="grid lg:grid-cols-2 place-items-center">
        ...
        <div className="items-center">
          <motion.h2 initial='offscreen' whileInView={'onscreen'} variants={titleVariants} className="px-12 py-4 text-3xl font-extrabold leading-tight lg:text-5xl">
            We are awards Winning Company
          </motion.h2>
          <motion.p initial='offscreen' whileInView={'onscreen'} variants={desVariants} className="px-12 tracking-wider uppercase text-gray-400 mt-3">
            World Award
          </motion.p>
          <motion.p initial='offscreen' whileInView={'onscreen'} variants={tagVariants} className="px-12 pb-4 mt-4">
            ...
            provide the best interior design fr your home. We have been trusted
            by many people to design their homes. We have also recived many
