    ...
    <div className="py-8 lg:py-28 container mx-auto">
      <div className="mx-auto grid pb-8 lg:grid-cols-1">
        <div className="text-center lg:text-left">
          ...
          <motion.h2 initial='offscreen' whileInView={'onscreen'} 
          variants={desVariants} className="pb-6 text-xl font-bold tracking-wider mt-5">
        ...
        <motion.div  initial='offscreen' whileInView={'onscreen'} 
          ...
          <p className="mx-auto">
            ...
            consequuntur, perferendis, quis fugit porro perspiciatis vel id
            magni eum.
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iste eius
